...
const qedLogo = require('./qed-logo');
...
module.exports = class extends Generator {
  prompting() {
    ...
    var prompts = [
      ...
      },
      {
        ...
        message: 'What is your theme\'s machine name? (EX: d8_theme)',
  ...
  configuring() {
    ...
    this.composeWith('qed-d8-theme:starter-kit', {
  ...
  install() {
    ...
    // and theme generator.
    // Adding the `yo generator-qed-d8-theme` so users can quickly
